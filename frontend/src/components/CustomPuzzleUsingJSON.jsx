    ...
    return (
        <div className="container-sm" id="crossword-code" style={{ display: showJsonText ? 'block' : 'none' }}>
            <form className="container-sm" id="cpuzzle-code">
                <textarea className="form-control text-white" rows="10" id="jsonpuzzle" value={jsonForm} onChange={(e) => setJsonForm(e.target.value)} >
                </textarea>
                <input data-i18n="load_json_button" type="button" className="btn btn-primary text-white" id="btn-restart" value="🚀 Cargar"
